...
$('.waifu-tool .fui-home').click(function (){
    window.location = 'https://www.cnblogs.com/HL-space/';
});
...
$('.waifu-tool .fui-photo').click(function (){
    showMessage('照好了吗，是不是很可爱呢？', 5000, true);
...
function waifuWelcome(){
    var text;
    var SiteIndexUrl = 'https://www.cnblogs.com/HL-space/';  // 手动指定主页
    ...
    if (window.location.href == SiteIndexUrl) {      // 如果是主页
        ...
        if(document.referrer !== ''){
            ...
            text = '欢迎阅读<span style="color:#0099cc;">『' + document.title.split(' - ')[0] + '』</span>，看完别忘点赞哟~';
        }
    }
...
var waifuJson = {
    "mouseover": [
        ...
        },
        {
            ...
            "text": ["这里都是小主人的黑历史呢", "想要知道更多有关主人的事吗？"]
        },
        {
        ...
        },
        {
            ...
            "text": ["干嘛呢你，快把手拿开！","三更灯火五更鸡，正是肥宅撸码时。","你是哪块小饼干？","关注一下小主人，和TA交个朋友吧~", "喜欢就赶紧点赞吧！", "初次见面，请多多关照~", "死肥宅又在偷看我！"]
        }
    ],
    "click": [
        {
            "selector": ".waifu #live2d",
            "text": ["看得舒服的话，就给小主人点个赞呗~", "萝莉控是什么鸭？", "终于等到你~", "你看到我的小熊了吗？","记住小主人的名字：秋~沐~霖~", "死肥宅不要再摸我啦！", "再摸的话我可要报警了！⌇●﹏●⌇", "妖妖灵吗，这里有个变态一直在摸我(ó﹏ò｡)","快快关注小主人吧，那样就能随时见到我啦~","有什么想说的吗？快给小主人留言吧~","死肥宅，再碰我就对你不客气啦！"]
        }
    ],
    "seasons": [
        {
